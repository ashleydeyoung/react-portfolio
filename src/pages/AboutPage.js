...
function AboutPage(props) {
    ...
    return(
        <div>
            ...
            <p className="font1">I am a full stack web developer based in Charlotte, North Carolina with experience in HTML, JavaScript, CSS, Third party APIs, JQuery, Express JS, Node JS, mySQL, MongoDB and React.</p>
            ...
            <p className="font1">You can checkout all my latest projects <a href="https://github.com/ashleydeyoung" target="_blank" rel="noopener noreferrer">here</a>, or on the Portfolio page.</p>
